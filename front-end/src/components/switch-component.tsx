...
export const useSwitchConstructor = (color: any) => {
    const appTheme = useTheme();
    
    const componentColors = {
        main:   ((appTheme.palette as any)[color.main.split(".")[0]].main),
        dark: ((appTheme.palette as any)[color.dark.split(".")[0]].dark),
        light: ((appTheme.palette as any)[color.border.split(".")[0]].border),
    };
    ...
    const themeConfig = (theme: any) => ({
        ...
        '& .MuiSwitch-switchBase': {
            ...
            '&.Mui-checked': {
                ...
                '& + .MuiSwitch-track': {
                    opacity: 1,
                    backgroundColor: componentColors.light, //'#ba68c8',
                },
            },
        },
        '& .MuiSwitch-thumb': {
            backgroundColor: componentColors.dark,// '#9c27b0',
            width: 32,
            height: 32,
            '&::before': {
                content: "''",
