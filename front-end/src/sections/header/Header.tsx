...
import { bgColor, COLORS, displayCenter, MAX_APPLICATION_WIDTH } from "../../theme/style"
...
const ThemeModeSwitch = styled(Switch)(({ theme }) => ({
    ...
    '& .MuiSwitch-thumb': {
      ...
      ...theme.applyStyles('dark', {
        backgroundColor: COLORS.USER.background, // '#003892',
      }),
    },
    '& .MuiSwitch-track': {
      opacity: 1,
